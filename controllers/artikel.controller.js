...
const artikelServices = require("../services/artikel.services");
...
exports.add = (req, res, next) => {
  const { lieferant, artikeltyp, kategorie, artnrlieferant, eancode, material,
    dimension, haptik, optik  } = req.body;

  //const salt = bcrypt.genSaltSync(10);
  //req.body.password = bcrypt.hashSync(password, salt);

  artikelServices.addartikel(req.body, (error, results) => {
    if (error) {
      return next(error);
    }
